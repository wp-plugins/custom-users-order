...
This plugin will order all the users with simple Drag and Drop Sortable capability.

== Description ==
This plugin will order all the users with simple Drag and Drop Sortable capability. Simply drag and drop the users into the desired position. It's that simple.
